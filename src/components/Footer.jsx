...
export default function Footer() {
    ...
    // ESC schließen + Body-Scroll sperren + Fokus setzen
    useEffect(() => {
        ...
        <footer className="footer">
            <div className="footer-container">
                ...
                <div className="footer-left">
                    ...
                    <div className="footer-social">
                        <a
                            href="https://github.com/TLOBLERIC"
                            target="_blank"
                            rel="noreferrer"
                            aria-label="GitHub"
                        >
                        ...
                        <a
                            href="https://instagram.com/loic_tob"
                            target="_blank"
                            rel="noreferrer"
            ...
            {open && (
                <div
                    ...
                    onClick={(e) =>
                        e.target.classList.contains("imp-overlay") && setOpen(false)
                    }
                >
                    <div className="imp-dialog" tabIndex={-1} ref={dialogRef}>
                        ...
                        <h2 id="imp-title" className="imp-title">Impressum</h2>
                        <p className="imp-lead">
                            Kurzinfo gemäß schweizerischem Recht. Für Anfragen einfach melden.
                        </p>
                        ...
                        <div className="imp-grid">
                            ...
                            <section className="imp-block">
                                <h3>Haftung</h3>
                                <p>
                                    Inhalte werden sorgfältig gepflegt – dennoch ohne Gewähr auf
                                    Richtigkeit, Vollständigkeit und Aktualität. Keine Haftung für
                                    externe Links.
                                </p>
                            </section>
                            ...
                            <section className="imp-block">
                                <h3>Urheberrecht</h3>
                                <p>
                                    Eigene Inhalte sind urheberrechtlich geschützt. Nutzung nur
                                    mit Einwilligung.
                                </p>
                            </section>
                            ...
                            <section className="imp-block">
                                <h3>Datenschutz</h3>
                                <p>
                                    Es werden nur notwendige, freiwillig übermittelte Daten
                                    verarbeitet (z.&nbsp;B. E-Mail). Keine Weitergabe an Dritte
                                    ohne Einwilligung.
                                </p>
                            </section>
                        </div>
                        ...
                        <button className="imp-primary" onClick={() => setOpen(false)}>
                            Verstanden
                        </button>
                    </div>
                </div>
